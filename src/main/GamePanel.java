...
public class GamePanel extends JPanel implements Runnable{
    ...
    //Kiểm tra xem nước đi có hợp lệ với vua hay không
    ...
    //Kiểm tra xem đối thủ có thể chiếu vua hay không
    ...
    //Lấy vua của người chơi được chỉ định
    ...
    //Kiểm tra xem vua có bị chiếu hết hay không
    ...
    //Kiểm tra trò chơi có ở trạng thái hòa không
    ...
    //Kiển tra quân tốt xem có thể phong cấp hay không
    ...
    public void paintComponent(Graphics g){
        ...
        if(promotion){
            ...
            for(Piece piece : promoPieces){
                g2.drawImage(piece.image, piece.getX(piece.col)+10, piece.getY(piece.row)+10, 80, 80, null);
            }
        }else{
            if(currentColor == WHITE){
                ...
                g2.drawString("Black's turn", 840, 100);
